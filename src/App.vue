...
// Import the useThemeStore function from the theme store
import { useThemeStore } from './stores/theme';

// Get the theme store instance
const store = useThemeStore()

// Define string constants for the light and dark modes
let light = 'Light-Mode'
let dark = 'Dark-Mode'
</script>
<template>
    <section :class="[{ containAllDay: !store.isDark }, { containAllNight: store.isDark }]">
    <!-- Toggle button for changing the theme -->
    ...
    <!-- Router view for rendering the current page -->
